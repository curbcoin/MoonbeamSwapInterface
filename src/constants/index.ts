...
// Moonbeam tokens
export const DAI_MOONBEAM = new Token(ChainId.MOONBEAM, '0x765277EebeCA2e31912C9946eAe1021199B39C61', 18, 'DAI', 'Dai Stablecoin');
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MOONBEAM]: [...WETH_ONLY[ChainId.MOONBEAM], DAI_MOONBEAM, USDC_MOONBEAM, USDT_MOONBEAM, BUSD_MOONBEAM, ETH_MOONBEAM, BNB_MOONBEAM],
};
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.MOONBEAM]: [
    [WETH[ChainId.MOONBEAM], USDC_MOONBEAM],
    [USDC_MOONBEAM, ETH_MOONBEAM],
    [USDC_MOONBEAM, USDT_MOONBEAM],
  ],
};
